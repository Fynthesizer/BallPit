...
namespace SteamAudio
{
    public sealed class FMODAudioEngineSource : AudioEngineSource
    {
        ...
        void BindToFMODStudioPlugin()
        {
            ...
            FMOD_DSP = Assembly.Load("FMODUnity").GetType("FMOD.DSP");
            FMOD_ChannelGroup = Assembly.Load("FMODUnity").GetType("FMOD.ChannelGroup");
            FMOD_Studio_EventInstance = Assembly.Load("FMODUnity").GetType("FMOD.Studio.EventInstance");
            FMODUnity_StudioEventEmitter = Assembly.Load("FMODUnity").GetType("FMODUnity.StudioEventEmitter");
